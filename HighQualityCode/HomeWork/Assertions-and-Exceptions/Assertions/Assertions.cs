...
public class Assertions
{
    ...
    {
        Debug.Assert(IsArrayValid(arr, 2), "Array cannot be null and must have minimum 2 elements to be sorted.");
    ...
    {
        Debug.Assert(IsArrayValid(arr, 1), "Cannot search in empty array.");
